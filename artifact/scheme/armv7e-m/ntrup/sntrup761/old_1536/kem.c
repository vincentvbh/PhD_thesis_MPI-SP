...
**************************************************/
static void Encrypt(Fq *c, small *r, Fq *h)
{
  Fq hr[POLY_N];
...
**************************************************/
static void Decrypt(small *r, Fq *c, small *f,const small *ginv)
{
  Fq cf[POLY_N];
  Fq cf3[POLY_N];
  small e[POLY_N];
...
**************************************************/
static void KeyGen(Fq *A, small *a, Fq *G)
{
  Fq aG[POLY_N];
...
**************************************************/
static void Encrypt(Fq *B,int8 *T,const int8 *r, Fq *G, Fq *A, small *b)
{
  Fq bG[POLY_N];
  Fq bA[POLY_N];
  int i;
...
**************************************************/
static void Decrypt(int8 *r, Fq *B,const int8 *T, small *a)
{
  Fq aB[POLY_N];
  int i;
...
**************************************************/
static void XEncrypt(Fq *B,int8 *T,const int8 *r,const unsigned char *S, Fq *A)
{
  Fq G[POLY_N];
  small b[POLY_N];
...
**************************************************/
static void ZEncrypt(unsigned char *C, Inputs r,const unsigned char *pk)
{
  Fq h[POLY_N];
  Fq c[POLY_N];
  Rq_decode(h,pk);
