...
testType = "profile_hashing"
schemeName = "ntru"
outFileName = f"{schemeName}/hash.txt"
iterations = 100
testedList = [["keygen hashing", "keypair hash cycles:"],
              ["encap hashing", "encaps hash cycles:"],
              ["decap hashing", "decaps hash cycles:"]
             ]
paramSetList = ["ntruhps2048677", "ntruhrss701"]
impleList = ["old_1536"]
cpu = ""
