...
**************************************************/
extern void _DILITHIUM_AARCH64__asm_poly_reduce(int32_t*, const int32_t*);
void poly_reduce(poly *a) {
    DBENCH_START();

    _DILITHIUM_AARCH64__asm_poly_reduce(a->coeffs, montgomery_const);
...
* Arguments:   - poly *a: pointer to input/output polynomial
**************************************************/
extern void _DILITHIUM_AARCH64__asm_poly_caddq(int32_t*, const int32_t*);
void poly_caddq(poly *a) {
    DBENCH_START();

    _DILITHIUM_AARCH64__asm_poly_caddq(a->coeffs, montgomery_const);
...
* Arguments:   - poly *a: pointer to input/output polynomial
**************************************************/
extern void _DILITHIUM_AARCH64__asm_poly_freeze(int32_t*, const int32_t*);
void poly_freeze(poly *a) {
    DBENCH_START();

    _DILITHIUM_AARCH64__asm_poly_freeze(a->coeffs, montgomery_const);
...
**************************************************/
extern void _DILITHIUM_AARCH64__asm_poly_pointwise_montgomery(int32_t *des, const int32_t *src1, const int32_t *src2, const int32_t *table);
void poly_pointwise_montgomery(poly *c, const poly *a, const poly *b) {
    DBENCH_START();

    _DILITHIUM_AARCH64__asm_poly_pointwise_montgomery(c->coeffs, a->coeffs, b->coeffs, montgomery_const);
...
**************************************************/
extern void _DILITHIUM_AARCH64__asm_poly_power2round(int32_t*, int32_t*, const int32_t*);
void poly_power2round(poly *a1, poly *a0, const poly *a) {
    DBENCH_START();

    _DILITHIUM_AARCH64__asm_poly_power2round(a1->coeffs, a0->coeffs, a->coeffs);
...
*              - const uint8_t *a: byte array with bit-packed polynomial
**************************************************/
extern void _DILITHIUM_AARCH64__asm_10_to_32(int32_t*, const uint8_t*);
void polyt1_unpack(poly *r, const uint8_t *a) {
    DBENCH_START();

    _DILITHIUM_AARCH64__asm_10_to_32(r->coeffs, a);
