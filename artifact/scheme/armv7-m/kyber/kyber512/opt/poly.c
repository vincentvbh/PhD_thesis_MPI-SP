...
void poly_compress(unsigned char *r, poly *a){
  ...
  __asm_compress4_core(r, a->coeffs, KYBER_N / 8);
#elif (KYBER_POLYCOMPRESSEDBYTES == 160)
  __asm_compress5_core(r, a->coeffs, KYBER_N / 8);
#else
...
void poly_packcompress(unsigned char *r, poly *a, int i) {
    ...
    __asm_compress11_core(r + 352 * i, a->coeffs, KYBER_N / 8);
#elif (KYBER_POLYVECCOMPRESSEDBYTES == (KYBER_K * 320))
    __asm_compress10_core(r + 320 * i, a->coeffs, KYBER_N / 8);
#else
 ...
 **************************************************/
extern void basemul_asm_opt_16_32(int32_t *, const int16_t *, const int16_t *, int16_t *);
void poly_basemul_opt_16_32(int32_t *r_tmp, const poly *a, const poly *b, poly_half *a_prime)
{
 ...
 *              - int32_t *r_tmp:      array for accumulating unreduced results
 **************************************************/
extern void basemul_asm_acc_opt_32_32(int32_t *, const int16_t *, const int16_t *, int16_t *);
void poly_basemul_acc_opt_32_32(int32_t *r_tmp, const poly *a, const poly *b, poly_half *a_prime)
{
 ...
 *              - int32_t *r_tmp:      array for accumulating unreduced results
 **************************************************/
extern void basemul_asm_acc_opt_32_16(int16_t *, const int16_t *, const int16_t *, int16_t *, int32_t *);
void poly_basemul_acc_opt_32_16(poly *r, const poly *a, const poly *b, poly_half *a_prime, int32_t *r_tmp)
{
...
void poly_tomsg(unsigned char msg[KYBER_SYMBYTES], poly *a) {
    __asm_compress1_core(msg, a->coeffs, KYBER_N / 8);
}
