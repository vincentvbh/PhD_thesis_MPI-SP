...
void matacc_cache_16_32(int32_t *r_tmp, const int16_t *b, int16_t c[4], unsigned char buf[XOF_BLOCKBYTES + 2], const uint32_t _zetas[64], xof_state *state, int16_t *bprimeptr)
{
...
void matacc_cache_32_32(int32_t *r_tmp, const int16_t *b, int16_t c[4], unsigned char buf[XOF_BLOCKBYTES + 2], const uint32_t _zetas[64], xof_state *state, int16_t *bprimeptr)
{
	unsigned int buflen, off;
	unsigned int ctr, pos, k, l;
	uint16_t val0, val1;
...
void matacc_cache_32_16(int16_t *r, const int16_t *b, int16_t c[4], unsigned char buf[XOF_BLOCKBYTES + 2], const uint32_t _zetas[64], xof_state *state, int16_t *bprimeptr, int32_t *r_tmp)
{
	unsigned int buflen, off;
	unsigned int ctr, pos, k, l;
	uint16_t val0, val1;
...
void matacc_opt_16_32(int32_t *r_tmp, const int16_t *b, int16_t c[4], unsigned char buf[XOF_BLOCKBYTES + 2], xof_state *state, int16_t *bprimeptr)
{
	unsigned int buflen, off;
	unsigned int ctr, pos, k, l;
	uint16_t val0, val1;
...
void matacc_opt_32_32(int32_t *r_tmp, const int16_t *b, int16_t c[4], unsigned char buf[XOF_BLOCKBYTES + 2], xof_state *state, int16_t *bprimeptr)
{
	unsigned int buflen, off;
	unsigned int ctr, pos, k, l;
	uint16_t val0, val1;
...
void matacc_opt_32_16(int16_t *r, const int16_t *b, int16_t c[4], unsigned char buf[XOF_BLOCKBYTES + 2], xof_state *state, int16_t *bprimeptr, int32_t *r_tmp)
{
	unsigned int buflen, off;
	unsigned int ctr, pos, k, l;
	uint16_t val0, val1;
