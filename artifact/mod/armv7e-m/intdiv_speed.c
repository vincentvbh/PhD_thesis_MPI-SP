...
int32_t smlawx(const int32_t c, const int32_t a, const int16_t b){
...
int16_t Barrett_compress_1(int16_t a){
    ...
    // return (smlawx(1 << 15, 2580335, a) >> 16) & 0x1;
...
int16_t Barrett_compress_4(int16_t a){
    ...
    // return (smlawx(1 << 15, 20642679, a) >> 16) & 0xf;
...
int16_t Barrett_compress_5(int16_t a){
    ...
    // return (smlawx(1 << 15, 41285357, a) >> 16) & 0x1f;
...
int16_t Barrett_compress_10(int16_t a){
    ...
    // return (smlawx(1 << 15, 1321131424, a) >> 16) & 0x3f;
...
int16_t Barrett_compress_11(int16_t a){
    ...
    return (smlawx(1 << 4, 1290167, a) >> 5) & 0x7ff;
}
...
extern void __asm_compress1_smmulr_core(uint8_t *des, const int16_t *src, const int32_t iter);
extern void __asm_compress4_smmulr_core(uint8_t *des, const int16_t *src, const size_t iter);
extern void __asm_compress5_smmulr_core(uint8_t *des, const int16_t *src, const size_t iter);
extern void __asm_compress10_smmulr_core(uint8_t *des, const int16_t *src, const size_t iter);
...
int main(void){
    ...
    hal_send_str("Start benchmarking...\n");
...
// Polynomial compression
    ...
    time1 = hal_get_time();
    sprintf(buff, "poly_compress1 ref cycles: %llu\n", time1 - time0);
    hal_send_str(buff);

    time0 = hal_get_time();
    poly_compress1(res, a);
    time1 = hal_get_time();
    sprintf(buff, "poly_compress1 cycles: %llu\n", time1 - time0);
    hal_send_str(buff);

    time0 = hal_get_time();
    __asm_compress1_smmulr_core(res, a, KYBER_N / 8);
    time1 = hal_get_time();
    sprintf(buff, "poly_compress1 smmulr cycles: %llu\n", time1 - time0);
    hal_send_str(buff);

    time0 = hal_get_time();
    __asm_compress1_core(res, a, KYBER_N / 16);
    time1 = hal_get_time();
    sprintf(buff, "poly_compress1 smlawx cycles: %llu\n", time1 - time0);
    hal_send_str(buff);

    time0 = hal_get_time();
    poly_compress4_ref(ref, a);
    time1 = hal_get_time();
    sprintf(buff, "poly_compress4 ref cycles: %llu\n", time1 - time0);
    hal_send_str(buff);

    time0 = hal_get_time();
    poly_compress4(res, a);
    time1 = hal_get_time();
    sprintf(buff, "poly_compress4 cycles: %llu\n", time1 - time0);
    hal_send_str(buff);

    time0 = hal_get_time();
    __asm_compress4_smmulr_core(res, a, KYBER_N / 8);
    time1 = hal_get_time();
    sprintf(buff, "poly_compress4 smmulr cycles: %llu\n", time1 - time0);
    hal_send_str(buff);

    time0 = hal_get_time();
    __asm_compress4_core(res, a, KYBER_N / 16);
    time1 = hal_get_time();
    sprintf(buff, "poly_compress4 smlawx cycles: %llu\n", time1 - time0);
    hal_send_str(buff);

    time0 = hal_get_time();
    poly_compress5_ref(ref, a);
    time1 = hal_get_time();
    sprintf(buff, "poly_compress5 ref cycles: %llu\n", time1 - time0);
    hal_send_str(buff);

    time0 = hal_get_time();
    poly_compress5(res, a);
    time1 = hal_get_time();
    sprintf(buff, "poly_compress5 cycles: %llu\n", time1 - time0);
    hal_send_str(buff);

    time0 = hal_get_time();
    __asm_compress5_smmulr_core(res, a, KYBER_N / 8);
    time1 = hal_get_time();
    sprintf(buff, "poly_compress5 smmulr cycles: %llu\n", time1 - time0);
    hal_send_str(buff);

    time0 = hal_get_time();
    __asm_compress5_core(res, a, KYBER_N / 16);
    time1 = hal_get_time();
    sprintf(buff, "poly_compress5 smlawx cycles: %llu\n", time1 - time0);
    hal_send_str(buff);

    time0 = hal_get_time();
    poly_compress10_ref(ref, a);
    time1 = hal_get_time();
    sprintf(buff, "poly_compress10 ref cycles: %llu\n", time1 - time0);
    hal_send_str(buff);

    time0 = hal_get_time();
    poly_compress10(res, a);
    time1 = hal_get_time();
    sprintf(buff, "poly_compress10 cycles: %llu\n", time1 - time0);
    hal_send_str(buff);

    time0 = hal_get_time();
    __asm_compress10_smmulr_core(res, a, KYBER_N / 8);
    time1 = hal_get_time();
    sprintf(buff, "poly_compress10 smmulr cycles: %llu\n", time1 - time0);
    hal_send_str(buff);

    time0 = hal_get_time();
    __asm_compress10_core(res, a, KYBER_N / 16);
    time1 = hal_get_time();
    sprintf(buff, "poly_compress10 smlawx cycles: %llu\n", time1 - time0);
    hal_send_str(buff);

    time0 = hal_get_time();
    poly_compress11_ref(ref, a);
    time1 = hal_get_time();
    sprintf(buff, "poly_compress11 ref cycles: %llu\n", time1 - time0);
    hal_send_str(buff);

    time0 = hal_get_time();
    poly_compress11(res, a);
    time1 = hal_get_time();
    sprintf(buff, "poly_compress11 cycles: %llu\n", time1 - time0);
    hal_send_str(buff);

    time0 = hal_get_time();
    __asm_compress11_core(res, a, KYBER_N / 16);
    time1 = hal_get_time();
    sprintf(buff, "poly_compress11 smlawx cycles: %llu\n", time1 - time0);
    hal_send_str(buff);
