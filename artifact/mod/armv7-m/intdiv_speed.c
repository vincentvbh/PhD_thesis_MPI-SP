...
// Polynomial compression
    ...
    time1 = hal_get_time();
    sprintf(buff, "poly_compress1 asm cycles: %llu\n", time1 - time0);
    hal_send_str(buff);
    ...
    time1 = hal_get_time();
    sprintf(buff, "poly_compress4 asm cycles: %llu\n", time1 - time0);
    hal_send_str(buff);
    ...
    time1 = hal_get_time();
    sprintf(buff, "poly_compress5 asm cycles: %llu\n", time1 - time0);
    hal_send_str(buff);
    ...
    time1 = hal_get_time();
    sprintf(buff, "poly_compress10 asm cycles: %llu\n", time1 - time0);
    hal_send_str(buff);
    ...
    time1 = hal_get_time();
    sprintf(buff, "poly_compress11 asm cycles: %llu\n", time1 - time0);
    hal_send_str(buff);
