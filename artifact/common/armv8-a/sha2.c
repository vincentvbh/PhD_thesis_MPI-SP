...
#ifdef BENCH_HASH
#define ACC sha2_cycles

#define TIME0 sha2_time0
#define TIME1 sha2_time1
...
#define BENCH_INIT() { TIME0 = get_cycle();}
#define BENCH_TAIL() { TIME1 = get_cycle(); ACC += TIME1 - TIME0;}
