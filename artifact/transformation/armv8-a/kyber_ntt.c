...
static const __attribute__ ((aligned (16)))int16_t asymmetric_const[8] = {
    Q, Qprime, RmodQ, RmodQ_hi
};

static const __attribute__ ((aligned (16)))int16_t constants[16] = {
    Q, Barrett26,
    FINAL_SCALE,
    FINAL_SCALE_hi,
    FINAL_SCALE_F,
...
static const __attribute__ ((aligned (16)))int16_t streamlined_CT_negacyclic_table_jump_extended[((NTT_N - 1) + (1 << 0) + (1 << 4) + NTT_N) << 1] = {
...
static const __attribute__ ((aligned (16)))int16_t pre_asymmetric_table_extended[ARRAY_N] = {
...
static const __attribute__ ((aligned (16)))int16_t streamlined_inv_GS_negacyclic_table_jump_extended[((NTT_N - 1) + (1 << 0) + (1 << 4) + NTT_N) << 1] = {
...
extern void __asm_ntt_SIMD_top(int16_t *des, const int16_t *table, const int16_t *_constants);
extern void __asm_ntt_SIMD_bot(int16_t *des, const int16_t *table, const int16_t *_constants);

extern void __asm_intt_SIMD_bot(int16_t *des, const int16_t *table, const int16_t *_constants);
extern void __asm_intt_SIMD_top(int16_t *des, const int16_t *table, const int16_t *_constants);

extern void __asm_point_mul_extended(int16_t *src_asymmetric, const int16_t *src, const int16_t *table, const int16_t *_asymmetric_const);
extern void __asm_asymmetric_mul_prototype(int16_t *des, const int16_t *src1, const int16_t *src2, const int16_t *src2_asymmetric, const int16_t *_constants);
extern void __asm_asymmetric_mul_montgomery_prototype(int16_t *des, const int16_t *src1, const int16_t *src2, const int16_t *src2_asymmetric, const int16_t *_constants);
...
#define MUL_TO_MONTGOMERY

int main(void){

    int16_t a[ARRAY_N], b[ARRAY_N], b_asymmetric[ARRAY_N >> 1];
    ...
    memset(a, 0, ARRAY_N * sizeof(int16_t));
    memset(b, 0, ARRAY_N * sizeof(int16_t));
    memset(b_asymmetric, 0, (ARRAY_N >> 1) * sizeof(int16_t));
    ...
    twiddle = -1;
    naive_mulR(ref, a, b, ARRAY_N, &twiddle, ring_h);

    __asm_ntt_SIMD_top(a, streamlined_CT_negacyclic_table_jump_extended, constants);
    __asm_ntt_SIMD_bot(a, streamlined_CT_negacyclic_table_jump_extended, constants);

    __asm_ntt_SIMD_top(b, streamlined_CT_negacyclic_table_jump_extended, constants);
    __asm_ntt_SIMD_bot(b, streamlined_CT_negacyclic_table_jump_extended, constants);

    __asm_point_mul_extended(b_asymmetric, b, pre_asymmetric_table_extended, asymmetric_const);

#ifdef MUL_TO_MONTGOMERY
    __asm_asymmetric_mul_montgomery_prototype(res, a, b, b_asymmetric, asymmetric_const);
#else
    __asm_asymmetric_mul_prototype(res, a, b, b_asymmetric, asymmetric_const);
#endif

    __asm_intt_SIMD_bot(res, streamlined_inv_GS_negacyclic_table_jump_extended, constants);
    __asm_intt_SIMD_top(res, streamlined_inv_GS_negacyclic_table_jump_extended, constants);

    for(size_t i = 0; i < ARRAY_N; i++){
        ring_h.memberZ(res + i, res + i);
    }
